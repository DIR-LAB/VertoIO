...
{
  thread name=wld_t,memsize=80m,instances=1
  {
    flowop read name=readOP,filename=largefile1,iosize=$iosize,random,workingset=$workingset,directio=$directio
  }
}
